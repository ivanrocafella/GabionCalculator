...
namespace GabionCalculator.DAL.Migrations
{
    ...
    [Migration("20230619055003_added field priceMaterial to gabion")]
    partial class addedfieldpriceMaterialtogabion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GabionCalculator.DAL.Entities.CostWork", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Margin = 1.2,
                            PNR = 7.0,
                            TimeSettingEguip = 5.0,
                            TimeWeldingOneCrossBar = 0.0050000000000000001
                        });
                });
            ...
            modelBuilder.Entity("GabionCalculator.DAL.Entities.Gabion", b =>
                {
                    ...
                    b.Property<double>("PriceMaterialBatch")
                        .HasColumnType("double")
                        .HasAnnotation("Relational:JsonPropertyName", "PriceMaterialBatch");
